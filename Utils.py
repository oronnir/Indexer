...
class Semaphore:
    ...
    def parallelize(self, items, do_work, timeout=1*3600):
        ...
        try:
            ...
            print(f"We lacked patience and got a multiprocessing.TimeoutError: {toe}")
            raise toe
        except Exception as e:
            print(f'MP parallelize has raised an exception: {e}')
            raise e
